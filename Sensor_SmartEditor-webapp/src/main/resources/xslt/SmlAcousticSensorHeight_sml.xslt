...
<xsl:stylesheet version="2.0"
	...
	<xsl:template
		match="/sml:SensorML/sml:member/sml:System/sml:characteristics/swe:DataRecord[@definition='urn:ogc:def:property:OGC:physicalProperties']/swe:field/swe:DataRecord/swe:field/swe:Quantity[@definition='urn:ogc:def:property:OGC:height']" />
	<xsl:template
		match="/sml:SensorML/sml:member/sml:System/sml:characteristics/swe:DataRecord[@definition='urn:ogc:def:property:OGC:physicalProperties']/swe:field/swe:DataRecord/swe:field[@name='height']" />
		...
		<xsl:copy>
			...
			<swe:field name="height">
				<swe:Quantity definition="urn:ogc:def:property:OGC:height"> 
                  <swe:uom code="mm"/> 
                  <swe:value><xsl:value-of select="$beanDoc/*/height" /></swe:value>
                </swe:Quantity> 
			</swe:field>
		</xsl:copy>
	</xsl:template>
