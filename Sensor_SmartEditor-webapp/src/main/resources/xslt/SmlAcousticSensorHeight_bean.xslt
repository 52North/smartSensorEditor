...
<xsl:stylesheet version="2.0"
	...
	<xsl:template match="/">
		<SmlAcousticSensorHeight>
			<height>
				<xsl:value-of select="//sml:member/sml:System/sml:characteristics/swe:DataRecord[@definition='urn:ogc:def:property:OGC:physicalProperties']/swe:field/swe:DataRecord/swe:field/swe:Quantity[@definition='urn:ogc:def:property:OGC:height']/swe:value" />
			</height>
		</SmlAcousticSensorHeight>
	</xsl:template>
</xsl:stylesheet>
