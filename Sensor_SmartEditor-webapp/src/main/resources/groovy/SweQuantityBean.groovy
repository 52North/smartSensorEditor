...
/**
	            <swe:extension></swe:extension> not implemented 
				<swe:identifier>test</swe:identifier>
				<swe:label>test</swe:label>
				<swe:description>test</swe:description>
				<swe:quality></swe:quality> not implemented because it is a complex type
				<swe:nilValues></swe:nilValues> not implemented because it is a complex type
				<swe:uom code="test"/>
