...
public class Test_GML_ID {
	...
	public void before() {
		backendManagerService.setMergeDocument(DOMUtil
				.createDocumentFromSystemID(
						"/validation/input/gml_ID.xml", true));
	}
	...
	public void testGML_ID_copied() {
		...
		assertThat(docString1, containsString("ExampleHydrophone1234"));

		String docString2 = DOMUtil.convertToString(
				backendManagerService.mergeBackend(), false);
		assertThat(docString2, containsString("ExampleHydrophone1234"));
